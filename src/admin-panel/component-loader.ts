...
export const customComponents = {
  ...
  AllCategoriesSelect: componentLoader.add('AllCategoriesSelect', path.join(__dirname, 'components/categories/all-parents-select.tsx')),
  ParentCategoryNameWithLabel: componentLoader.add('ParentCategoryNameWithLabel', path.join(__dirname, 'components/categories/parent-category-with-label.tsx')),
  CustomCategorySelect: componentLoader.add('CustomCategorySelect', path.join(__dirname, 'components/categories/parent-category-select.tsx')),
  ParentCategoryName: componentLoader.add('ParentCategoryName', path.join(__dirname, 'components/categories/parent-category-name.tsx')),
  ...
  CustomCategoryIconList: componentLoader.add('CustomCategoryIconList', path.join(__dirname, 'components/categories/custom-icon-list.tsx')),
  ...
  AuctionCategoryCard: componentLoader.add('AuctionCategoryCard', path.join(__dirname, 'components/auctions/category-card.tsx')),
  AuctionAssets: componentLoader.add('AuctionAssets', path.join(__dirname, 'components/auctions/assets.tsx')),
  AuctionAssetsCarousel: componentLoader.add('AuctionAssetsCarousel', path.join(__dirname, 'components/auctions/assets-carousel.tsx')),
  BulkDeleteButton: componentLoader.add('BulkDeleteButton', path.join(__dirname, 'components/common/bulk-delete-button.tsx')),
  CustomCategoryIconEdit: componentLoader.add('CustomCategoryIconEdit', path.join(__dirname, 'components/categories/custom-icon.tsx')),
  CategoryUploadedIcon: componentLoader.add('CategoryUploadedIcon', path.join(__dirname, 'components/categories/icon.tsx')),
  SendAccountNotificationModal: componentLoader.add('SendAccountNotificationModal', path.join(__dirname, 'components/accounts/send-notification-modal.tsx')),
